...
def add_variation(
    ...
    # Don't apply timing offset - it adds silence padding
    # Just use the audio as-is after pitch shift
...
def generate_single_note_variations(
    ...
    # Auto-detect articulation from input filename if not overridden
    if articulation == "downstroke":  # default value
        input_filename = os.path.basename(input_wav).lower()
        if "palm_mute_down" in input_filename:
            articulation = "palm_mute_down"
        elif "palm_mute_up" in input_filename:
            articulation = "palm_mute_up"
        elif "palm_mute" in input_filename:
            articulation = "palm_mute"
        elif "upstroke" in input_filename:
            articulation = "upstroke"
        elif "downstroke" in input_filename:
    ...
    # Trim silence first to get clean audio
    base_audio = trim_silence(audio)
